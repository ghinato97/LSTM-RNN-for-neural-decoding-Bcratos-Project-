...
if __name__=='__main__':
    ...
    train_df, test_df = train_test_split(df, test_size=0.8, random_state=42, stratify=df.obj_id)
    ...
    print('\nDimensioni del train dataset:')
    print(X_Train.shape)
    
    print('\nDimensioni del test dataset:')
    print(X_Test.shape)
    ...
    if not os.path.exists(os.path.join(args.outdir,data_prefix,'PCA_Dataset_Metodo2')):
        os.makedirs(os.path.join(args.outdir,data_prefix,'PCA_Dataset_Metodo2'))
    ...
    with open(os.path.join(args.outdir,data_prefix,'PCA_Dataset_Metodo2','binary_trainset.npz'), 'bw') as trainfile:
        np.savez(trainfile, X=data_set_train_bin, y=label_train_bin)
    with open(os.path.join(args.outdir,data_prefix,'PCA_Dataset_Metodo2','binary_full.npz'), 'bw') as trainfile:
        np.savez(trainfile, X=data_set_bin, y=label_bin)
    with open(os.path.join(args.outdir,data_prefix,'PCA_Dataset_Metodo2','binary_testset.npz'), 'bw') as testfile:
    ...
    with open(os.path.join(args.outdir,data_prefix,'PCA_Dataset_Metodo2','multi_full.npz'), 'bw') as trainfile:
        np.savez(trainfile, X=data_set_multi, y=label_multi)
    with open(os.path.join(args.outdir,data_prefix,'PCA_Dataset_Metodo2','multi_trainset.npz'), 'bw') as trainfile:
        np.savez(trainfile, X=data_set_train_multi, y=label_train_multi)
    with open(os.path.join(args.outdir,data_prefix,'PCA_Dataset_Metodo2','multi_testset.npz'), 'bw') as testfile:
